...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Minnal public bot' : process.env.ALL_CAPTION,
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '917510241003@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'MINNAL BOT' : process.env.BOT_NAME,
    ...
    RASHI: process.env.LOGO_LINK === undefined ? 'https://www.linkpicture.com/q/PicsArt_12-01-09.26.44_4.jpg' : process.env.LOGO_LINK,
    ...
    TAGPLK: process.env.TAG_HEADER === undefined ? 'minnal' : process.env.TAG_HEADER,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    MAHN: process.env.MAAN === undefined ? '917510241003,0' : process.env.MAAN,
    BRANCH: 'master',
    HEROKU: {
